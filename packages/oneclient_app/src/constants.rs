...
pub const UPDATER_ENDPOINT: &str =
    "https://github.com/oiupoyt/onelauncher-but-cracked/releases/latest/download/latest.json";
pub const RELEASES_URL: &str = "https://github.com/oiupoyt/onelauncher-but-cracked/releases/latest";
